...
(defun my-color-theme ()
  "Color theme by Thomas Schilling, created 2008-07-02."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (comint-highlight-prompt ((t (:bold t :background "bisque" :foreground "gold4" :weight bold))))
     ...
     (custom-button ((t (:foreground "#99c" :underline t))))
     ...
     (custom-link ((t (:foreground "blue4" :underline t))))
     ...
     (diff-added ((t (:background "#225500"))))
     (diff-added-face ((t (:background "#225500"))))
     (diff-changed ((t (nil))))
     ...
     (diff-removed ((t (:background "#551111"))))
     (diff-removed-face ((t (:background "#551111"))))
     (dired-directory ((t (:bold t :foreground "slateblue3" :weight bold))))
     ...
     (dired-perm-write ((t (:foreground "gray70" :background "gray97"))))
     ...
     (erc-current-nick-face ((t (:background "antiquewhite1" :foreground "peru"))))
     ...
     (erc-nick-default-face ((t (:foreground "peru"))))
     ...
     (font-latex-sectioning-0-face ((t (:bold t :foreground "blue4" :weight bold :height 1.6105100000000008 :family "helv"))))
     (font-latex-sectioning-1-face ((t (:bold t :foreground "blue4" :weight bold :height 1.4641000000000006 :family "helv"))))
     (font-latex-sectioning-2-face ((t (:bold t :foreground "blue4" :weight bold :height 1.3310000000000004 :family "helv"))))
     (font-latex-sectioning-3-face ((t (:bold t :foreground "blue4" :weight bold :height 1.2100000000000002 :family "helv"))))
     (font-latex-sectioning-4-face ((t (:bold t :foreground "blue4" :weight bold :height 1.1 :family "helv"))))
     (font-latex-sectioning-5-face ((t (:bold t :foreground "blue4" :weight bold :family "helv"))))
     (font-latex-sedate-face ((t (:foreground "Gray50"))))
     (font-latex-slide-title-face ((t (:bold t :weight bold :height 1.2 :family "helv"))))
     (font-latex-string-face ((t (:foreground "orange4"))))
     (font-latex-subscript-face ((t (:height 0.8))))
     (font-latex-superscript-face ((t (:height 0.8))))
     (font-latex-verbatim-face ((t (:foreground "SaddleBrown" :family "courier"))))
     (font-latex-warning-face ((t (:foreground "gold"))))
     (font-lock-builtin-face ((t (:foreground "gray57"))))
     (font-lock-comment-delimiter-face ((t (:background "gray97" :foreground "gray70"))))
     (font-lock-comment-face ((t (:background "gray97" :foreground "gray70"))))
     (font-lock-constant-face ((t (:background "floral white" :foreground "gold4"))))
     ...
     (font-lock-function-name-face ((t (:background "#eeffcc" :foreground "#339900"))))
     ...
     (font-lock-string-face ((t (:background "gray95" :foreground "black"))))
     (font-lock-type-def-face ((t (nil))))
     (font-lock-type-face ((t (:foreground "#993020" :underline nil))))
     (font-lock-variable-name-face ((t (:foreground "grey50"))))
     ...
     (highlight ((t (:background "blue4" :foreground "white"))))
     ...
     (ido-first-match ((t (:background "#ccff66"))))
     ...
     (ido-only-match ((t (:background "YellowGreen" :foreground "#ffffcc"))))
     ...
     (lazy-highlight ((t (:background "gray90"))))
     ...
     (link ((t (:foreground "blue4" :underline t))))
     ...
     (mode-line ((t (:background "#ffdd99" :foreground "gray50"))))
     (mode-line-buffer-id ((t (:foreground "MediumBlue"))))
     ...
     (next-error ((t (:background "grey90"))))
     (nil ((t (nil))))
     (nobreak-space ((t (nil))))
     ...
     (primary-selection ((t (:background "gray90"))))
     ...
     (smerge-base ((t (:foreground "red1"))))
     (smerge-base-face ((t (:foreground "red1"))))
     (smerge-markers ((t (:background "grey85"))))
     (smerge-markers-face ((t (:background "grey85"))))
     (smerge-mine ((t (:foreground "blue1"))))
     (smerge-mine-face ((t (:foreground "blue1"))))
     (smerge-other ((t (:foreground "darkgreen"))))
     (smerge-other-face ((t (:foreground "darkgreen"))))
     (smerge-refined-change ((t (:background "yellow"))))
     ...
     (widget-field ((t (:background "gray80" :foreground "black"))))
     ...
     (zmacs-region ((t (:background "grey90")))))))
