...
(defun my-color-theme ()
  "Color theme by Thomas Schilling, created 2008-04-27."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (custom-link ((t (:underline t :foreground "blue4"))))
     ...
     (font-latex-sectioning-0-face ((t (:bold t :weight bold :foreground "blue4" :family "helv" :height 1.6105100000000008))))
     (font-latex-sectioning-1-face ((t (:bold t :family "helv" :foreground "blue4" :weight bold :height 1.4641000000000006))))
     (font-latex-sectioning-2-face ((t (:bold t :weight bold :foreground "blue4" :family "helv" :height 1.3310000000000004))))
     (font-latex-sectioning-3-face ((t (:bold t :family "helv" :foreground "blue4" :weight bold :height 1.2100000000000002))))
     (font-latex-sectioning-4-face ((t (:bold t :weight bold :foreground "blue4" :family "helv" :height 1.1))))
     (font-latex-sectioning-5-face ((t (:bold t :family "helv" :foreground "blue4" :weight bold))))
     (font-latex-sedate-face ((t (:foreground "Gray50"))))
     (font-latex-slide-title-face ((t (:bold t :family "helv" :weight bold :height 1.2))))
     ...
     (font-latex-verbatim-face ((t (:family "courier" :foreground "SaddleBrown"))))
     (font-latex-warning-face ((t (:foreground "gold"))))
     (font-lock-builtin-face ((t (:foreground "gray57"))))
     (font-lock-comment-delimiter-face ((t (:foreground "gray70" :background "gray97"))))
     ...
     (lazy-highlight ((t (:background "gray45"))))
     ...
     (makefile-targets ((t (:foreground "#339900" :background "#eeffcc"))))
