...
(defun my-color-theme ()
  "Color theme by Thomas Schilling, created 2008-07-04."
  (interactive)
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "gray20" :foreground "gray70" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :family "apple-monaco"))))
     ...
     (TeX-fold-folded-face ((t (:foreground "SlateBlue1"))))
     (TeX-fold-unfolded-face ((t (:background "#38405d"))))
     ...
     (dired-perm-write ((t (:background "gray97" :foreground "gray70"))))
     ...
     (erc-notice-face ((t (:foreground "gray45"))))
     ...
     (font-lock-string-face ((t (:background "gray17" :foreground "gray60"))))
     (font-lock-type-def-face ((t (nil))))
     (font-lock-type-face ((t (:foreground "DarkOrange2" :underline nil))))
     ...
     (makefile-targets ((t (:foreground "gold"))))
     ...
     (mode-line ((t (:background "gray10" :foreground "white" :box (:line-width -1 :color "gray40")))))
     (mode-line-buffer-id ((t (:foreground "Gold2"))))
