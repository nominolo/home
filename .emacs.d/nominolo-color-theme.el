...
(defun my-color-theme ()
  ...
  (color-theme-install
   '(my-color-theme
     ...
     (default ((t (:stipple nil :background "gray20" :foreground "gray70" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 141 :width normal :family "apple-inconsolata"))))
     ...
     (nxml-outline-active-indicator-face ((t (:stipple nil :background "gray20" :foreground "gray70" :inverse-video nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal :family "apple-inconsolata" :box 1 :height 141))))
     (nxml-outline-ellipsis-face ((t (:bold t :family "apple-inconsolata" :width normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "gray70" :background "gray20" :stipple nil :weight bold :height 141))))
     (nxml-outline-indicator-face ((t (:family "apple-inconsolata" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "gray70" :background "gray20" :stipple nil :height 141))))
